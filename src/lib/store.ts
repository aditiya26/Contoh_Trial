...
export const MULTI_OUTPUT_PERUNTUKAN = ["Mutasi", "Repair", "Regrading", "Produksi"];
...
export const MODULE_FIELDS: Record<ModuleKey, FieldDef[]> = {
  "bahan-baku": [
    F("noLog"), F("tanggal"), F("kodeBahan"), F("jenisBahan"), F("kategori"),
    F("noBox"), F("gudang"), F("peruntukan"), F("sumber"),
  ...
  "barang-perjalanan": [
    F("noLog"), F("tanggal"), F("kodeBahan"), F("jenisBahan"), F("kategori"),
    F("gudang"), F("peruntukan"), F("sumber"), F("vendor"), F("customer"),
    F("qtyAwal"), F("masuk"), F("keluar"), F("qtyAkhir"),
    F("noJo"), F("keterangan"),
  ],
  "pemakaian": [
    F("noLog"), F("tanggal"), F("kodeBahan"), F("jenisBahan"), F("kategori"),
    F("noBox"), F("peruntukan"), F("sumber"), F("gudang"),
    F("masuk"), F("keluar"),
    F("noJo"), F("customer"), F("vendor"), F("keterangan"),
  ],
};
...
const DEFAULT_SETTINGS: Settings = {
  peruntukan: ["Produksi", "Mutasi", "Repair", "Regrading", "Sample", "Stok", "Maintenance"],
  ...
  persist(
    (set, get) => ({
      ...
      seedSampleData: (user) => {
        ...
        const blank = {
          noBox: "", peruntukan: "Stok", jenisBahan: "Kain", kategori: "A",
          keluar: 0, masuk: 0, gudang: "Gudang Utama", sumber: "Pembelian Awal",
